      ...
      when (element) {
        ...
        is JsonObject -> {
          ...
          if (jobj.size == 1) {
            ...
            val typeField = jobj["type"]?.jsonPrimitive?.contentOrNull ?: throw SerializationException("Missing 'type' discriminator in RpcQueryRequest")
            when (typeField) {
              "view_account_by_block_id" -> {
              ...
              else -> throw SerializationException("Unknown type discriminator for RpcQueryRequest: " + typeField)
            }
          }
        }
      }
