          ...
          if (jobj.size == 1) {
            ...
            when (key) {
              "result" -> {
                ...
                val resultVal = decoder.json.decodeFromJsonElement(ListSerializer(serializer<RangeOfUint64>()), obj["result"] ?: throw SerializationException("Missing field 'result' for variant " + key))
