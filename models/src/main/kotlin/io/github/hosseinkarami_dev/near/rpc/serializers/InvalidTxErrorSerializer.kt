...
public object InvalidTxErrorSerializer : KSerializer<InvalidTxError> {
  ...
  override fun serialize(encoder: Encoder, `value`: InvalidTxError) {
    ...
    when (value) {
      is InvalidTxError.InvalidAccessKeyError -> out.encodeSerializableElement(descriptor, 0, serializer<InvalidAccessKeyError>(), value.invalidAccessKeyError)
      is InvalidTxError.InvalidSignerId -> out.encodeSerializableElement(descriptor, 1, serializer<InvalidTxError.InvalidSignerId.InvalidSignerIdPayload>(), value.invalidSignerId)
      is InvalidTxError.SignerDoesNotExist -> out.encodeSerializableElement(descriptor, 2, serializer<InvalidTxError.SignerDoesNotExist.SignerDoesNotExistPayload>(), value.signerDoesNotExist)
      is InvalidTxError.InvalidNonce -> out.encodeSerializableElement(descriptor, 3, serializer<InvalidTxError.InvalidNonce.InvalidNoncePayload>(), value.invalidNonce)
      is InvalidTxError.NonceTooLarge -> out.encodeSerializableElement(descriptor, 4, serializer<InvalidTxError.NonceTooLarge.NonceTooLargePayload>(), value.nonceTooLarge)
      is InvalidTxError.InvalidReceiverId -> out.encodeSerializableElement(descriptor, 5, serializer<InvalidTxError.InvalidReceiverId.InvalidReceiverIdPayload>(), value.invalidReceiverId)
      InvalidTxError.InvalidSignature -> out.encodeStringElement(descriptor, 6, "InvalidSignature")
      is InvalidTxError.NotEnoughBalance -> out.encodeSerializableElement(descriptor, 7, serializer<InvalidTxError.NotEnoughBalance.NotEnoughBalancePayload>(), value.notEnoughBalance)
      is InvalidTxError.LackBalanceForState -> out.encodeSerializableElement(descriptor, 8, serializer<InvalidTxError.LackBalanceForState.LackBalanceForStatePayload>(), value.lackBalanceForState)
      InvalidTxError.CostOverflow -> out.encodeStringElement(descriptor, 9, "CostOverflow")
      InvalidTxError.InvalidChain -> out.encodeStringElement(descriptor, 10, "InvalidChain")
      InvalidTxError.Expired -> out.encodeStringElement(descriptor, 11, "Expired")
      is InvalidTxError.ActionsValidation -> out.encodeSerializableElement(descriptor, 12, serializer<ActionsValidationError>(), value.actionsValidation)
      is InvalidTxError.TransactionSizeExceeded -> out.encodeSerializableElement(descriptor, 13, serializer<InvalidTxError.TransactionSizeExceeded.TransactionSizeExceededPayload>(), value.transactionSizeExceeded)
      InvalidTxError.InvalidTransactionVersion -> out.encodeStringElement(descriptor, 14, "InvalidTransactionVersion")
      is InvalidTxError.StorageError -> out.encodeSerializableElement(descriptor, 15, serializer<StorageError>(), value.storageError)
      is InvalidTxError.ShardCongested -> out.encodeSerializableElement(descriptor, 16, serializer<InvalidTxError.ShardCongested.ShardCongestedPayload>(), value.shardCongested)
      is InvalidTxError.ShardStuck -> out.encodeSerializableElement(descriptor, 17, serializer<InvalidTxError.ShardStuck.ShardStuckPayload>(), value.shardStuck)
    }
          ...
          if (jobj.size == 1) {
            ...
            when (key) {
              "InvalidAccessKeyError" -> {
                ...
                val invalidAccessKeyErrorVal = decoder.json.decodeFromJsonElement(serializer<InvalidAccessKeyError>(), obj["InvalidAccessKeyError"] ?: throw SerializationException("Missing field 'InvalidAccessKeyError' for variant " + key))
                return InvalidTxError.InvalidAccessKeyError(invalidAccessKeyErrorVal)
              }
              "InvalidSignerId" -> {
                val obj = valueElem as? JsonObject ?: throw SerializationException("Expected object payload for variant " + key)
                val invalidSignerIdVal = decoder.json.decodeFromJsonElement(serializer<InvalidTxError.InvalidSignerId.InvalidSignerIdPayload>(), obj["InvalidSignerId"] ?: throw SerializationException("Missing field 'InvalidSignerId' for variant " + key))
                return InvalidTxError.InvalidSignerId(invalidSignerIdVal)
              }
              "SignerDoesNotExist" -> {
                val obj = valueElem as? JsonObject ?: throw SerializationException("Expected object payload for variant " + key)
                val signerDoesNotExistVal = decoder.json.decodeFromJsonElement(serializer<InvalidTxError.SignerDoesNotExist.SignerDoesNotExistPayload>(), obj["SignerDoesNotExist"] ?: throw SerializationException("Missing field 'SignerDoesNotExist' for variant " + key))
                return InvalidTxError.SignerDoesNotExist(signerDoesNotExistVal)
              }
              "InvalidNonce" -> {
                val obj = valueElem as? JsonObject ?: throw SerializationException("Expected object payload for variant " + key)
                val invalidNonceVal = decoder.json.decodeFromJsonElement(serializer<InvalidTxError.InvalidNonce.InvalidNoncePayload>(), obj["InvalidNonce"] ?: throw SerializationException("Missing field 'InvalidNonce' for variant " + key))
                return InvalidTxError.InvalidNonce(invalidNonceVal)
              }
              "NonceTooLarge" -> {
                val obj = valueElem as? JsonObject ?: throw SerializationException("Expected object payload for variant " + key)
                val nonceTooLargeVal = decoder.json.decodeFromJsonElement(serializer<InvalidTxError.NonceTooLarge.NonceTooLargePayload>(), obj["NonceTooLarge"] ?: throw SerializationException("Missing field 'NonceTooLarge' for variant " + key))
                return InvalidTxError.NonceTooLarge(nonceTooLargeVal)
              }
              "InvalidReceiverId" -> {
                val obj = valueElem as? JsonObject ?: throw SerializationException("Expected object payload for variant " + key)
                val invalidReceiverIdVal = decoder.json.decodeFromJsonElement(serializer<InvalidTxError.InvalidReceiverId.InvalidReceiverIdPayload>(), obj["InvalidReceiverId"] ?: throw SerializationException("Missing field 'InvalidReceiverId' for variant " + key))
                return InvalidTxError.InvalidReceiverId(invalidReceiverIdVal)
              }
              "NotEnoughBalance" -> {
                val obj = valueElem as? JsonObject ?: throw SerializationException("Expected object payload for variant " + key)
                val notEnoughBalanceVal = decoder.json.decodeFromJsonElement(serializer<InvalidTxError.NotEnoughBalance.NotEnoughBalancePayload>(), obj["NotEnoughBalance"] ?: throw SerializationException("Missing field 'NotEnoughBalance' for variant " + key))
                return InvalidTxError.NotEnoughBalance(notEnoughBalanceVal)
              }
              "LackBalanceForState" -> {
                val obj = valueElem as? JsonObject ?: throw SerializationException("Expected object payload for variant " + key)
                val lackBalanceForStateVal = decoder.json.decodeFromJsonElement(serializer<InvalidTxError.LackBalanceForState.LackBalanceForStatePayload>(), obj["LackBalanceForState"] ?: throw SerializationException("Missing field 'LackBalanceForState' for variant " + key))
                return InvalidTxError.LackBalanceForState(lackBalanceForStateVal)
              }
              "ActionsValidation" -> {
                val obj = valueElem as? JsonObject ?: throw SerializationException("Expected object payload for variant " + key)
              ...
              "TransactionSizeExceeded" -> {
                val obj = valueElem as? JsonObject ?: throw SerializationException("Expected object payload for variant " + key)
                val transactionSizeExceededVal = decoder.json.decodeFromJsonElement(serializer<InvalidTxError.TransactionSizeExceeded.TransactionSizeExceededPayload>(), obj["TransactionSizeExceeded"] ?: throw SerializationException("Missing field 'TransactionSizeExceeded' for variant " + key))
                return InvalidTxError.TransactionSizeExceeded(transactionSizeExceededVal)
              }
              "StorageError" -> {
                val obj = valueElem as? JsonObject ?: throw SerializationException("Expected object payload for variant " + key)
                val storageErrorVal = decoder.json.decodeFromJsonElement(serializer<StorageError>(), obj["StorageError"] ?: throw SerializationException("Missing field 'StorageError' for variant " + key))
                return InvalidTxError.StorageError(storageErrorVal)
              }
              "ShardCongested" -> {
                val obj = valueElem as? JsonObject ?: throw SerializationException("Expected object payload for variant " + key)
                val shardCongestedVal = decoder.json.decodeFromJsonElement(serializer<InvalidTxError.ShardCongested.ShardCongestedPayload>(), obj["ShardCongested"] ?: throw SerializationException("Missing field 'ShardCongested' for variant " + key))
                return InvalidTxError.ShardCongested(shardCongestedVal)
              }
              "ShardStuck" -> {
                val obj = valueElem as? JsonObject ?: throw SerializationException("Expected object payload for variant " + key)
                val shardStuckVal = decoder.json.decodeFromJsonElement(serializer<InvalidTxError.ShardStuck.ShardStuckPayload>(), obj["ShardStuck"] ?: throw SerializationException("Missing field 'ShardStuck' for variant " + key))
                return InvalidTxError.ShardStuck(shardStuckVal)
              }
              "InvalidSignature" -> {
            ...
            val typeField = jobj["type"]?.jsonPrimitive?.contentOrNull ?: throw SerializationException("Missing 'type' discriminator in InvalidTxError")
            when (typeField) {
              "InvalidAccessKeyError" -> {
              ...
              else -> throw SerializationException("Unknown type discriminator for InvalidTxError: " + typeField)
            }
          }
        }
      }
