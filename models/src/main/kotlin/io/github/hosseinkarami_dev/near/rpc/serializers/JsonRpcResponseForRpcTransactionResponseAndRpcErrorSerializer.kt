      ...
      when (element) {
        ...
        is JsonObject -> {
          ...
          if (jobj.size == 1) {
            ...
            if (typeField == null) throw SerializationException("Missing discriminator (one of type/name) or recognizable variant in JsonRpcResponseForRpcTransactionResponseAndRpcError")
