...
public sealed class ValidatorKickoutReason {
  ...
  public data class UnusedSlashed(
    public val `value`: String = "_UnusedSlashed",
  ...
  @Serializable
  @SerialName("Unstaked")
  public data class Unstaked(
    public val `value`: String = "Unstaked",
  ) : ValidatorKickoutReason()
  ...
  public data class DidNotGetASeat(
    public val `value`: String = "DidNotGetASeat",
  ) : ValidatorKickoutReason()
