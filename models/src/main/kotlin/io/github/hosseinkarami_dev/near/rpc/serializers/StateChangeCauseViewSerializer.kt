      ...
      when (element) {
        ...
        is JsonObject -> {
          ...
          if (jobj["tx_hash"] != null) {
            val txHashVal = decoder.json.decodeFromJsonElement(serializer<CryptoHash>(), jobj["tx_hash"] ?: throw SerializationException("Missing field 'tx_hash' for variant " + "TransactionProcessing"))
            val typeVal = decoder.json.decodeFromJsonElement(serializer<StateChangeCauseView.TransactionProcessing.Type>(), jobj["type"] ?: throw SerializationException("Missing field 'type' for variant " + "TransactionProcessing"))
          ...
          if (jobj.size == 1) {
            ...
            when (key) {
              "not_writable_to_disk" -> {
                ...
                return decoder.json.decodeFromJsonElement(serializer<StateChangeCauseView.NotWritableToDisk>(), obj)
              }
              "initial_state" -> {
                val obj = valueElem as? JsonObject ?: throw SerializationException("Expected object payload for variant " + key)
                return decoder.json.decodeFromJsonElement(serializer<StateChangeCauseView.InitialState>(), obj)
              }
              "transaction_processing" -> {
                val obj = valueElem as? JsonObject ?: throw SerializationException("Expected object payload for variant " + key)
                return decoder.json.decodeFromJsonElement(serializer<StateChangeCauseView.TransactionProcessing>(), obj)
              }
              "action_receipt_processing_started" -> {
                val obj = valueElem as? JsonObject ?: throw SerializationException("Expected object payload for variant " + key)
                return decoder.json.decodeFromJsonElement(serializer<StateChangeCauseView.ActionReceiptProcessingStarted>(), obj)
              }
              "action_receipt_gas_reward" -> {
                val obj = valueElem as? JsonObject ?: throw SerializationException("Expected object payload for variant " + key)
                return decoder.json.decodeFromJsonElement(serializer<StateChangeCauseView.ActionReceiptGasReward>(), obj)
              }
              "receipt_processing" -> {
                val obj = valueElem as? JsonObject ?: throw SerializationException("Expected object payload for variant " + key)
                return decoder.json.decodeFromJsonElement(serializer<StateChangeCauseView.ReceiptProcessing>(), obj)
              }
              "postponed_receipt" -> {
                val obj = valueElem as? JsonObject ?: throw SerializationException("Expected object payload for variant " + key)
                return decoder.json.decodeFromJsonElement(serializer<StateChangeCauseView.PostponedReceipt>(), obj)
              }
              "updated_delayed_receipts" -> {
                val obj = valueElem as? JsonObject ?: throw SerializationException("Expected object payload for variant " + key)
                return decoder.json.decodeFromJsonElement(serializer<StateChangeCauseView.UpdatedDelayedReceipts>(), obj)
              }
              "validator_accounts_update" -> {
                val obj = valueElem as? JsonObject ?: throw SerializationException("Expected object payload for variant " + key)
                return decoder.json.decodeFromJsonElement(serializer<StateChangeCauseView.ValidatorAccountsUpdate>(), obj)
              }
              "migration" -> {
                val obj = valueElem as? JsonObject ?: throw SerializationException("Expected object payload for variant " + key)
                return decoder.json.decodeFromJsonElement(serializer<StateChangeCauseView.Migration>(), obj)
              }
              "bandwidth_scheduler_state_update" -> {
                val obj = valueElem as? JsonObject ?: throw SerializationException("Expected object payload for variant " + key)
                return decoder.json.decodeFromJsonElement(serializer<StateChangeCauseView.BandwidthSchedulerStateUpdate>(), obj)
              }
