      ...
      when (element) {
        ...
        is JsonObject -> {
          ...
          if (jobj["InvalidPredecessorId"] != null) {
            return ReceiptValidationError.InvalidPredecessorId(decoder.json.decodeFromJsonElement(serializer<ReceiptValidationError.InvalidPredecessorId.InvalidPredecessorIdPayload>(), jobj["InvalidPredecessorId"]!!))
          }
          if (jobj["InvalidReceiverId"] != null) {
            return ReceiptValidationError.InvalidReceiverId(decoder.json.decodeFromJsonElement(serializer<ReceiptValidationError.InvalidReceiverId.InvalidReceiverIdPayload>(), jobj["InvalidReceiverId"]!!))
          }
          if (jobj["InvalidSignerId"] != null) {
            return ReceiptValidationError.InvalidSignerId(decoder.json.decodeFromJsonElement(serializer<ReceiptValidationError.InvalidSignerId.InvalidSignerIdPayload>(), jobj["InvalidSignerId"]!!))
          }
          if (jobj["InvalidDataReceiverId"] != null) {
            return ReceiptValidationError.InvalidDataReceiverId(decoder.json.decodeFromJsonElement(serializer<ReceiptValidationError.InvalidDataReceiverId.InvalidDataReceiverIdPayload>(), jobj["InvalidDataReceiverId"]!!))
          }
          if (jobj["ReturnedValueLengthExceeded"] != null) {
            return ReceiptValidationError.ReturnedValueLengthExceeded(decoder.json.decodeFromJsonElement(serializer<ReceiptValidationError.ReturnedValueLengthExceeded.ReturnedValueLengthExceededPayload>(), jobj["ReturnedValueLengthExceeded"]!!))
          }
          if (jobj["NumberInputDataDependenciesExceeded"] != null) {
            return ReceiptValidationError.NumberInputDataDependenciesExceeded(decoder.json.decodeFromJsonElement(serializer<ReceiptValidationError.NumberInputDataDependenciesExceeded.NumberInputDataDependenciesExceededPayload>(), jobj["NumberInputDataDependenciesExceeded"]!!))
          }
          if (jobj["ActionsValidation"] != null) {
            return ReceiptValidationError.ActionsValidation(decoder.json.decodeFromJsonElement(serializer<ActionsValidationError>(), jobj["ActionsValidation"]!!))
          }
          if (jobj["ReceiptSizeExceeded"] != null) {
            return ReceiptValidationError.ReceiptSizeExceeded(decoder.json.decodeFromJsonElement(serializer<ReceiptValidationError.ReceiptSizeExceeded.ReceiptSizeExceededPayload>(), jobj["ReceiptSizeExceeded"]!!))
          }
          if (jobj.size == 1) {
            ...
            when (key) {
              "InvalidPredecessorId" -> {
                ...
                return decoder.json.decodeFromJsonElement(serializer<ReceiptValidationError.InvalidPredecessorId>(), obj)
              }
              "InvalidReceiverId" -> {
                val obj = valueElem as? JsonObject ?: throw SerializationException("Expected object payload for variant " + key)
                return decoder.json.decodeFromJsonElement(serializer<ReceiptValidationError.InvalidReceiverId>(), obj)
              }
              "InvalidSignerId" -> {
                val obj = valueElem as? JsonObject ?: throw SerializationException("Expected object payload for variant " + key)
                return decoder.json.decodeFromJsonElement(serializer<ReceiptValidationError.InvalidSignerId>(), obj)
              }
              "InvalidDataReceiverId" -> {
                val obj = valueElem as? JsonObject ?: throw SerializationException("Expected object payload for variant " + key)
                return decoder.json.decodeFromJsonElement(serializer<ReceiptValidationError.InvalidDataReceiverId>(), obj)
              }
              "ReturnedValueLengthExceeded" -> {
                val obj = valueElem as? JsonObject ?: throw SerializationException("Expected object payload for variant " + key)
                return decoder.json.decodeFromJsonElement(serializer<ReceiptValidationError.ReturnedValueLengthExceeded>(), obj)
              }
              "NumberInputDataDependenciesExceeded" -> {
                val obj = valueElem as? JsonObject ?: throw SerializationException("Expected object payload for variant " + key)
                return decoder.json.decodeFromJsonElement(serializer<ReceiptValidationError.NumberInputDataDependenciesExceeded>(), obj)
              }
              "ActionsValidation" -> {
                val obj = valueElem as? JsonObject ?: throw SerializationException("Expected object payload for variant " + key)
                return decoder.json.decodeFromJsonElement(serializer<ReceiptValidationError.ActionsValidation>(), obj)
              }
              "ReceiptSizeExceeded" -> {
                val obj = valueElem as? JsonObject ?: throw SerializationException("Expected object payload for variant " + key)
                return decoder.json.decodeFromJsonElement(serializer<ReceiptValidationError.ReceiptSizeExceeded>(), obj)
              }
