      ...
      when (element) {
        ...
        is JsonObject -> {
          ...
          if (jobj["epoch_id"] != null) {
            return RpcValidatorRequest.EpochId(decoder.json.decodeFromJsonElement(serializer<EpochId>(), jobj["epoch_id"]!!))
          }
          if (jobj["block_id"] != null) {
            return RpcValidatorRequest.BlockId(decoder.json.decodeFromJsonElement(serializer<BlockId>(), jobj["block_id"]!!))
          }
          if (jobj.size == 1) {
