      ...
      when (element) {
        ...
        is JsonObject -> {
          ...
          if (jobj["AccessKeyNotFound"] != null) {
            return InvalidAccessKeyError.AccessKeyNotFound(decoder.json.decodeFromJsonElement(serializer<InvalidAccessKeyError.AccessKeyNotFound.AccessKeyNotFoundPayload>(), jobj["AccessKeyNotFound"]!!))
          }
          if (jobj["ReceiverMismatch"] != null) {
            return InvalidAccessKeyError.ReceiverMismatch(decoder.json.decodeFromJsonElement(serializer<InvalidAccessKeyError.ReceiverMismatch.ReceiverMismatchPayload>(), jobj["ReceiverMismatch"]!!))
          }
          if (jobj["MethodNameMismatch"] != null) {
            return InvalidAccessKeyError.MethodNameMismatch(decoder.json.decodeFromJsonElement(serializer<InvalidAccessKeyError.MethodNameMismatch.MethodNameMismatchPayload>(), jobj["MethodNameMismatch"]!!))
          }
          if (jobj["NotEnoughAllowance"] != null) {
            return InvalidAccessKeyError.NotEnoughAllowance(decoder.json.decodeFromJsonElement(serializer<InvalidAccessKeyError.NotEnoughAllowance.NotEnoughAllowancePayload>(), jobj["NotEnoughAllowance"]!!))
          }
          if (jobj.size == 1) {
            ...
            when (key) {
              "AccessKeyNotFound" -> {
                ...
                return decoder.json.decodeFromJsonElement(serializer<InvalidAccessKeyError.AccessKeyNotFound>(), obj)
              }
              "ReceiverMismatch" -> {
                val obj = valueElem as? JsonObject ?: throw SerializationException("Expected object payload for variant " + key)
                return decoder.json.decodeFromJsonElement(serializer<InvalidAccessKeyError.ReceiverMismatch>(), obj)
              }
              "MethodNameMismatch" -> {
                val obj = valueElem as? JsonObject ?: throw SerializationException("Expected object payload for variant " + key)
                return decoder.json.decodeFromJsonElement(serializer<InvalidAccessKeyError.MethodNameMismatch>(), obj)
              }
              "NotEnoughAllowance" -> {
                val obj = valueElem as? JsonObject ?: throw SerializationException("Expected object payload for variant " + key)
                return decoder.json.decodeFromJsonElement(serializer<InvalidAccessKeyError.NotEnoughAllowance>(), obj)
              }
              "RequiresFullAccess" -> {
