...
public sealed class InvalidAccessKeyError {
  ...
  public data class RequiresFullAccess(
    public val `value`: String = "RequiresFullAccess",
  ) : InvalidAccessKeyError()
  ...
  public data class DepositWithFunctionCall(
    public val `value`: String = "DepositWithFunctionCall",
  ) : InvalidAccessKeyError()
}
