...
public sealed class InvalidTxError {
  ...
  public data class InvalidSignature(
    public val `value`: String = "InvalidSignature",
  ) : InvalidTxError()
  ...
  public data class CostOverflow(
    public val `value`: String = "CostOverflow",
  ) : InvalidTxError()
  ...
  public data class InvalidChain(
    public val `value`: String = "InvalidChain",
  ) : InvalidTxError()
  ...
  public data class Expired(
    public val `value`: String = "Expired",
  ) : InvalidTxError()
  ...
  public data class InvalidTransactionVersion(
    public val `value`: String = "InvalidTransactionVersion",
  ) : InvalidTxError()
