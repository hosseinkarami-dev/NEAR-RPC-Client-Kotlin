          ...
          if (jobj.size == 1) {
            ...
            when (key) {
              "account_changes_by_block_id" -> {
                ...
                return decoder.json.decodeFromJsonElement(serializer<RpcStateChangesInBlockByTypeRequest.AccountChangesByBlockId>(), obj)
              }
              "single_access_key_changes_by_block_id" -> {
                val obj = valueElem as? JsonObject ?: throw SerializationException("Expected object payload for variant " + key)
                return decoder.json.decodeFromJsonElement(serializer<RpcStateChangesInBlockByTypeRequest.SingleAccessKeyChangesByBlockId>(), obj)
              }
              "single_gas_key_changes_by_block_id" -> {
                val obj = valueElem as? JsonObject ?: throw SerializationException("Expected object payload for variant " + key)
                return decoder.json.decodeFromJsonElement(serializer<RpcStateChangesInBlockByTypeRequest.SingleGasKeyChangesByBlockId>(), obj)
              }
              "all_access_key_changes_by_block_id" -> {
                val obj = valueElem as? JsonObject ?: throw SerializationException("Expected object payload for variant " + key)
                return decoder.json.decodeFromJsonElement(serializer<RpcStateChangesInBlockByTypeRequest.AllAccessKeyChangesByBlockId>(), obj)
              }
              "all_gas_key_changes_by_block_id" -> {
                val obj = valueElem as? JsonObject ?: throw SerializationException("Expected object payload for variant " + key)
                return decoder.json.decodeFromJsonElement(serializer<RpcStateChangesInBlockByTypeRequest.AllGasKeyChangesByBlockId>(), obj)
              }
              "contract_code_changes_by_block_id" -> {
                val obj = valueElem as? JsonObject ?: throw SerializationException("Expected object payload for variant " + key)
                return decoder.json.decodeFromJsonElement(serializer<RpcStateChangesInBlockByTypeRequest.ContractCodeChangesByBlockId>(), obj)
              }
              "data_changes_by_block_id" -> {
                val obj = valueElem as? JsonObject ?: throw SerializationException("Expected object payload for variant " + key)
                return decoder.json.decodeFromJsonElement(serializer<RpcStateChangesInBlockByTypeRequest.DataChangesByBlockId>(), obj)
              }
              "account_changes_by_finality" -> {
                val obj = valueElem as? JsonObject ?: throw SerializationException("Expected object payload for variant " + key)
                return decoder.json.decodeFromJsonElement(serializer<RpcStateChangesInBlockByTypeRequest.AccountChangesByFinality>(), obj)
              }
              "single_access_key_changes_by_finality" -> {
                val obj = valueElem as? JsonObject ?: throw SerializationException("Expected object payload for variant " + key)
                return decoder.json.decodeFromJsonElement(serializer<RpcStateChangesInBlockByTypeRequest.SingleAccessKeyChangesByFinality>(), obj)
              }
              "single_gas_key_changes_by_finality" -> {
                val obj = valueElem as? JsonObject ?: throw SerializationException("Expected object payload for variant " + key)
                return decoder.json.decodeFromJsonElement(serializer<RpcStateChangesInBlockByTypeRequest.SingleGasKeyChangesByFinality>(), obj)
              }
              "all_access_key_changes_by_finality" -> {
                val obj = valueElem as? JsonObject ?: throw SerializationException("Expected object payload for variant " + key)
                return decoder.json.decodeFromJsonElement(serializer<RpcStateChangesInBlockByTypeRequest.AllAccessKeyChangesByFinality>(), obj)
              }
              "all_gas_key_changes_by_finality" -> {
                val obj = valueElem as? JsonObject ?: throw SerializationException("Expected object payload for variant " + key)
                return decoder.json.decodeFromJsonElement(serializer<RpcStateChangesInBlockByTypeRequest.AllGasKeyChangesByFinality>(), obj)
              }
              "contract_code_changes_by_finality" -> {
                val obj = valueElem as? JsonObject ?: throw SerializationException("Expected object payload for variant " + key)
                return decoder.json.decodeFromJsonElement(serializer<RpcStateChangesInBlockByTypeRequest.ContractCodeChangesByFinality>(), obj)
              }
              "data_changes_by_finality" -> {
                val obj = valueElem as? JsonObject ?: throw SerializationException("Expected object payload for variant " + key)
                return decoder.json.decodeFromJsonElement(serializer<RpcStateChangesInBlockByTypeRequest.DataChangesByFinality>(), obj)
              }
              "account_changes_by_sync_checkpoint" -> {
                val obj = valueElem as? JsonObject ?: throw SerializationException("Expected object payload for variant " + key)
                return decoder.json.decodeFromJsonElement(serializer<RpcStateChangesInBlockByTypeRequest.AccountChangesBySyncCheckpoint>(), obj)
              }
              "single_access_key_changes_by_sync_checkpoint" -> {
                val obj = valueElem as? JsonObject ?: throw SerializationException("Expected object payload for variant " + key)
                return decoder.json.decodeFromJsonElement(serializer<RpcStateChangesInBlockByTypeRequest.SingleAccessKeyChangesBySyncCheckpoint>(), obj)
              }
              "single_gas_key_changes_by_sync_checkpoint" -> {
                val obj = valueElem as? JsonObject ?: throw SerializationException("Expected object payload for variant " + key)
                return decoder.json.decodeFromJsonElement(serializer<RpcStateChangesInBlockByTypeRequest.SingleGasKeyChangesBySyncCheckpoint>(), obj)
              }
              "all_access_key_changes_by_sync_checkpoint" -> {
                val obj = valueElem as? JsonObject ?: throw SerializationException("Expected object payload for variant " + key)
                return decoder.json.decodeFromJsonElement(serializer<RpcStateChangesInBlockByTypeRequest.AllAccessKeyChangesBySyncCheckpoint>(), obj)
              }
              "all_gas_key_changes_by_sync_checkpoint" -> {
                val obj = valueElem as? JsonObject ?: throw SerializationException("Expected object payload for variant " + key)
                return decoder.json.decodeFromJsonElement(serializer<RpcStateChangesInBlockByTypeRequest.AllGasKeyChangesBySyncCheckpoint>(), obj)
              }
              "contract_code_changes_by_sync_checkpoint" -> {
                val obj = valueElem as? JsonObject ?: throw SerializationException("Expected object payload for variant " + key)
                return decoder.json.decodeFromJsonElement(serializer<RpcStateChangesInBlockByTypeRequest.ContractCodeChangesBySyncCheckpoint>(), obj)
              }
              "data_changes_by_sync_checkpoint" -> {
                val obj = valueElem as? JsonObject ?: throw SerializationException("Expected object payload for variant " + key)
                return decoder.json.decodeFromJsonElement(serializer<RpcStateChangesInBlockByTypeRequest.DataChangesBySyncCheckpoint>(), obj)
              }
