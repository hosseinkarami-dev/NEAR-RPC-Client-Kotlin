...
public sealed class StorageError {
  ...
  public data class StorageInternalError(
    public val `value`: String = "StorageInternalError",
  ) : StorageError()
  ...
  public data class UnexpectedTrieValue(
    public val `value`: String = "UnexpectedTrieValue",
  ) : StorageError()
