    ...
    if (decoder is JsonDecoder) {
      ...
      when (element) {
        ...
        is JsonObject -> {
          val jobj = element
          if (jobj["Action"] != null) {
            return ReceiptEnumView.Action(decoder.json.decodeFromJsonElement(serializer<ReceiptEnumView.Action.ActionPayload>(), jobj["Action"]!!))
          }
          if (jobj["Data"] != null) {
            return ReceiptEnumView.Data(decoder.json.decodeFromJsonElement(serializer<ReceiptEnumView.Data.DataPayload>(), jobj["Data"]!!))
          }
          if (jobj["GlobalContractDistribution"] != null) {
            return ReceiptEnumView.GlobalContractDistribution(decoder.json.decodeFromJsonElement(serializer<ReceiptEnumView.GlobalContractDistribution.GlobalContractDistributionPayload>(), jobj["GlobalContractDistribution"]!!))
          }
          if (jobj.size == 1) {
