          ...
          if (jobj.size == 1) {
            ...
            when (key) {
              "account_update" -> {
                ...
                return decoder.json.decodeFromJsonElement(serializer<StateChangeWithCauseView.AccountUpdate>(), obj)
              }
              "account_deletion" -> {
                val obj = valueElem as? JsonObject ?: throw SerializationException("Expected object payload for variant " + key)
                return decoder.json.decodeFromJsonElement(serializer<StateChangeWithCauseView.AccountDeletion>(), obj)
              }
              "access_key_update" -> {
                val obj = valueElem as? JsonObject ?: throw SerializationException("Expected object payload for variant " + key)
                return decoder.json.decodeFromJsonElement(serializer<StateChangeWithCauseView.AccessKeyUpdate>(), obj)
              }
              "access_key_deletion" -> {
                val obj = valueElem as? JsonObject ?: throw SerializationException("Expected object payload for variant " + key)
                return decoder.json.decodeFromJsonElement(serializer<StateChangeWithCauseView.AccessKeyDeletion>(), obj)
              }
              "gas_key_update" -> {
                val obj = valueElem as? JsonObject ?: throw SerializationException("Expected object payload for variant " + key)
                return decoder.json.decodeFromJsonElement(serializer<StateChangeWithCauseView.GasKeyUpdate>(), obj)
              }
              "gas_key_nonce_update" -> {
                val obj = valueElem as? JsonObject ?: throw SerializationException("Expected object payload for variant " + key)
                return decoder.json.decodeFromJsonElement(serializer<StateChangeWithCauseView.GasKeyNonceUpdate>(), obj)
              }
              "gas_key_deletion" -> {
                val obj = valueElem as? JsonObject ?: throw SerializationException("Expected object payload for variant " + key)
                return decoder.json.decodeFromJsonElement(serializer<StateChangeWithCauseView.GasKeyDeletion>(), obj)
              }
              "data_update" -> {
                val obj = valueElem as? JsonObject ?: throw SerializationException("Expected object payload for variant " + key)
                return decoder.json.decodeFromJsonElement(serializer<StateChangeWithCauseView.DataUpdate>(), obj)
              }
              "data_deletion" -> {
                val obj = valueElem as? JsonObject ?: throw SerializationException("Expected object payload for variant " + key)
                return decoder.json.decodeFromJsonElement(serializer<StateChangeWithCauseView.DataDeletion>(), obj)
              }
              "contract_code_update" -> {
                val obj = valueElem as? JsonObject ?: throw SerializationException("Expected object payload for variant " + key)
                return decoder.json.decodeFromJsonElement(serializer<StateChangeWithCauseView.ContractCodeUpdate>(), obj)
              }
              "contract_code_deletion" -> {
                val obj = valueElem as? JsonObject ?: throw SerializationException("Expected object payload for variant " + key)
                return decoder.json.decodeFromJsonElement(serializer<StateChangeWithCauseView.ContractCodeDeletion>(), obj)
              }
            ...
            if (typeField == null) throw SerializationException("Missing discriminator (one of change/type) or recognizable variant in StateChangeWithCauseView")
