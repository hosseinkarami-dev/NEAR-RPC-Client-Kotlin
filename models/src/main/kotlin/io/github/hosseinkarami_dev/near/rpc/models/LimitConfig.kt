...
public data class LimitConfig(
  ...
  public val initialMemoryPages: UInt,
  /**
  ...
  public val maxActionsPerReceipt: ULong,
  /**
  ...
  public val maxArgumentsLength: ULong,
  /**
   *  * Max contract size
   *  * Minimum: 0.0
   *  * Format: uint64
  ...
  public val maxContractSize: ULong,
  /**
  ...
  public val maxLengthMethodName: ULong,
  /**
  ...
  public val maxLengthReturnedData: ULong,
  /**
  ...
  public val maxLengthStorageKey: ULong,
  /**
  ...
  public val maxLengthStorageValue: ULong,
  /**
  ...
  public val maxMemoryPages: UInt,
  /**
  ...
  public val maxNumberBytesMethodNames: ULong,
  /**
  ...
  public val maxNumberInputDataDependencies: ULong,
  /**
  ...
  public val maxNumberLogs: ULong,
  /**
  ...
  public val maxNumberRegisters: ULong,
  /**
  ...
  public val maxPromisesPerFunctionCallAction: ULong,
  /**
   *  * Max receipt size
   *  * Minimum: 0.0
   *  * Format: uint64
  ...
  public val maxReceiptSize: ULong,
  /**
  ...
  public val maxRegisterSize: ULong,
  /**
  ...
  public val maxStackHeight: UInt,
  /**
  ...
  public val maxTotalLogLength: ULong,
  /**
  ...
  public val maxTransactionSize: ULong,
  /**
  ...
  public val maxYieldPayloadSize: ULong,
  /**
  ...
  public val perReceiptStorageProofSizeLimit: UInt,
  /**
  ...
  public val registersMemoryLimit: ULong,
  /**
  ...
  public val yieldTimeoutLengthInBlocks: ULong,
)
