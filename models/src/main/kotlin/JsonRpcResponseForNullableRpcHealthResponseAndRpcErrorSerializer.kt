...
object JsonRpcResponseForNullableRpcHealthResponseAndRpcErrorSerializer : KSerializer<JsonRpcResponseForNullableRpcHealthResponseAndRpcError> {

    override val descriptor: SerialDescriptor = buildClassSerialDescriptor("io.github.hosseinkarami_dev.near.rpc.models.JsonRpcResponseForNullableRpcHealthResponseAndRpcError") {
        element("result", serializer<JsonElement>().descriptor)
        element("error", serializer<JsonElement>().descriptor)
    }

    override fun serialize(encoder: Encoder, value: JsonRpcResponseForNullableRpcHealthResponseAndRpcError) {
        if (encoder is JsonEncoder) {
            val jsonEncoder = encoder
            when (value) {
                is io.github.hosseinkarami_dev.near.rpc.models.JsonRpcResponseForNullableRpcHealthResponseAndRpcError.Result -> {
                    val map = mutableMapOf<String, JsonElement>()
                    if (value.result != null) {
                        map["result"] = jsonEncoder.json.encodeToJsonElement(serializer<io.github.hosseinkarami_dev.near.rpc.models.RpcHealthResponse?>(), value.result)
                    }
                ...
                is io.github.hosseinkarami_dev.near.rpc.models.JsonRpcResponseForNullableRpcHealthResponseAndRpcError.Error -> {
                    val map = mutableMapOf<String, JsonElement>()
        ...
        when (value) {
            is io.github.hosseinkarami_dev.near.rpc.models.JsonRpcResponseForNullableRpcHealthResponseAndRpcError.Result -> out.encodeSerializableElement(descriptor, 0, serializer<io.github.hosseinkarami_dev.near.rpc.models.JsonRpcResponseForNullableRpcHealthResponseAndRpcError.Result>(), value)
            is io.github.hosseinkarami_dev.near.rpc.models.JsonRpcResponseForNullableRpcHealthResponseAndRpcError.Error -> out.encodeSerializableElement(descriptor, 1, serializer<io.github.hosseinkarami_dev.near.rpc.models.JsonRpcResponseForNullableRpcHealthResponseAndRpcError.Error>(), value)
        }
        out.endStructure(descriptor)
    }

    override fun deserialize(decoder: Decoder): JsonRpcResponseForNullableRpcHealthResponseAndRpcError {
        if (decoder is JsonDecoder) {
            ...
            when (element) {
                is JsonPrimitive -> {
                    ...
                    throw SerializationException("Unknown discriminator (primitive) for JsonRpcResponseForNullableRpcHealthResponseAndRpcError")
                }
                is JsonArray -> throw SerializationException("Unexpected JSON array while deserializing JsonRpcResponseForNullableRpcHealthResponseAndRpcError")
                is JsonObject -> {
                    val jobj = element
                    if (jobj["result"] != null) {
                        ...
                        return io.github.hosseinkarami_dev.near.rpc.models.JsonRpcResponseForNullableRpcHealthResponseAndRpcError.Result(resultVal, idVal, jsonrpcVal)
                    }
                    if (jobj["error"] != null) {
                        ...
                        return io.github.hosseinkarami_dev.near.rpc.models.JsonRpcResponseForNullableRpcHealthResponseAndRpcError.Error(errorVal, idVal, jsonrpcVal)
                    }
                    if (jobj.size == 1) {
                    ...
                    if (typeField == null) throw SerializationException("Missing discriminator (one of changes_type) or recognizable variant in JsonRpcResponseForNullableRpcHealthResponseAndRpcError")
                    val tf = typeField.trim()

                    // try exact match of full variant name first
                    val tfFull = tf
                    when (tfFull) {
                        "result" -> return decoder.json.decodeFromJsonElement(serializer<io.github.hosseinkarami_dev.near.rpc.models.JsonRpcResponseForNullableRpcHealthResponseAndRpcError.Result>(), jobj)
                        "error" -> return decoder.json.decodeFromJsonElement(serializer<io.github.hosseinkarami_dev.near.rpc.models.JsonRpcResponseForNullableRpcHealthResponseAndRpcError.Error>(), jobj)
                    ...
                    if (jobj.containsKey("id") && jobj.containsKey("jsonrpc")) requiredMatches.add(0)
                    if (jobj.containsKey("error") && jobj.containsKey("id") && jobj.containsKey("jsonrpc")) requiredMatches.add(1)
                    if (requiredMatches.size == 1) {
                        when (requiredMatches[0]) {
                            0 -> return decoder.json.decodeFromJsonElement(serializer<io.github.hosseinkarami_dev.near.rpc.models.JsonRpcResponseForNullableRpcHealthResponseAndRpcError.Result>(), jobj)
                            1 -> return decoder.json.decodeFromJsonElement(serializer<io.github.hosseinkarami_dev.near.rpc.models.JsonRpcResponseForNullableRpcHealthResponseAndRpcError.Error>(), jobj)
                    ...
                    try { return decoder.json.decodeFromJsonElement(serializer<io.github.hosseinkarami_dev.near.rpc.models.JsonRpcResponseForNullableRpcHealthResponseAndRpcError.Result>(), jobj) } catch (_: Exception) { }
                    try { return decoder.json.decodeFromJsonElement(serializer<io.github.hosseinkarami_dev.near.rpc.models.JsonRpcResponseForNullableRpcHealthResponseAndRpcError.Error>(), jobj) } catch (_: Exception) { }
                    throw SerializationException("Missing discriminator or recognizable variant in JsonRpcResponseForNullableRpcHealthResponseAndRpcError")
                }
            }
        }
        throw SerializationException("Cannot deserialize JsonRpcResponseForNullableRpcHealthResponseAndRpcError with non-JSON decoder")
    }
}
