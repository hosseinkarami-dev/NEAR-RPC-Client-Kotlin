        ...
        if (decoder is JsonDecoder) {
            ...
            when (element) {
                ...
                is JsonObject -> {
                    ...
                    if (typeField == null) throw SerializationException("Missing discriminator (one of changes_type) or recognizable variant in JsonRpcResponseForRpcTransactionResponseAndRpcError")
