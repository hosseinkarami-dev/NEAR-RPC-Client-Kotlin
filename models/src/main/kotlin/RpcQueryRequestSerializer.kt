        ...
        if (decoder is JsonDecoder) {
            ...
            when (element) {
                ...
                is JsonObject -> {
                    ...
                    if (typeField == null) throw SerializationException("Missing discriminator (one of changes_type) or recognizable variant in RpcQueryRequest")
                    ...
                    if (chosenGroupKey != null) {
                        when (chosenGroupKey) {
                            "view_account" -> {
                                if (jobj["block_id"] != null) return decoder.json.decodeFromJsonElement(serializer<io.github.hosseinkarami_dev.near.rpc.models.RpcQueryRequest.ViewAccountByBlockId>(), jobj)
                                if (jobj["finality"] != null) return decoder.json.decodeFromJsonElement(serializer<io.github.hosseinkarami_dev.near.rpc.models.RpcQueryRequest.ViewAccountByFinality>(), jobj)
                                if (jobj["sync_checkpoint"] != null) return decoder.json.decodeFromJsonElement(serializer<io.github.hosseinkarami_dev.near.rpc.models.RpcQueryRequest.ViewAccountBySyncCheckpoint>(), jobj)
                            ...
                            "view_code" -> {
                                if (jobj["block_id"] != null) return decoder.json.decodeFromJsonElement(serializer<io.github.hosseinkarami_dev.near.rpc.models.RpcQueryRequest.ViewCodeByBlockId>(), jobj)
                                if (jobj["finality"] != null) return decoder.json.decodeFromJsonElement(serializer<io.github.hosseinkarami_dev.near.rpc.models.RpcQueryRequest.ViewCodeByFinality>(), jobj)
                                if (jobj["sync_checkpoint"] != null) return decoder.json.decodeFromJsonElement(serializer<io.github.hosseinkarami_dev.near.rpc.models.RpcQueryRequest.ViewCodeBySyncCheckpoint>(), jobj)
                            ...
                            "view_state" -> {
                                if (jobj["block_id"] != null) return decoder.json.decodeFromJsonElement(serializer<io.github.hosseinkarami_dev.near.rpc.models.RpcQueryRequest.ViewStateByBlockId>(), jobj)
                                if (jobj["finality"] != null) return decoder.json.decodeFromJsonElement(serializer<io.github.hosseinkarami_dev.near.rpc.models.RpcQueryRequest.ViewStateByFinality>(), jobj)
                                if (jobj["sync_checkpoint"] != null) return decoder.json.decodeFromJsonElement(serializer<io.github.hosseinkarami_dev.near.rpc.models.RpcQueryRequest.ViewStateBySyncCheckpoint>(), jobj)
                            ...
                            "view_access_key" -> {
                                if (jobj["block_id"] != null) return decoder.json.decodeFromJsonElement(serializer<io.github.hosseinkarami_dev.near.rpc.models.RpcQueryRequest.ViewAccessKeyByBlockId>(), jobj)
                                if (jobj["finality"] != null) return decoder.json.decodeFromJsonElement(serializer<io.github.hosseinkarami_dev.near.rpc.models.RpcQueryRequest.ViewAccessKeyByFinality>(), jobj)
                                if (jobj["sync_checkpoint"] != null) return decoder.json.decodeFromJsonElement(serializer<io.github.hosseinkarami_dev.near.rpc.models.RpcQueryRequest.ViewAccessKeyBySyncCheckpoint>(), jobj)
                            ...
                            "view_access_key_list" -> {
                                if (jobj["block_id"] != null) return decoder.json.decodeFromJsonElement(serializer<io.github.hosseinkarami_dev.near.rpc.models.RpcQueryRequest.ViewAccessKeyListByBlockId>(), jobj)
                                if (jobj["finality"] != null) return decoder.json.decodeFromJsonElement(serializer<io.github.hosseinkarami_dev.near.rpc.models.RpcQueryRequest.ViewAccessKeyListByFinality>(), jobj)
                                if (jobj["sync_checkpoint"] != null) return decoder.json.decodeFromJsonElement(serializer<io.github.hosseinkarami_dev.near.rpc.models.RpcQueryRequest.ViewAccessKeyListBySyncCheckpoint>(), jobj)
                            ...
                            "call_function" -> {
                                if (jobj["block_id"] != null) return decoder.json.decodeFromJsonElement(serializer<io.github.hosseinkarami_dev.near.rpc.models.RpcQueryRequest.CallFunctionByBlockId>(), jobj)
                                if (jobj["finality"] != null) return decoder.json.decodeFromJsonElement(serializer<io.github.hosseinkarami_dev.near.rpc.models.RpcQueryRequest.CallFunctionByFinality>(), jobj)
                                if (jobj["sync_checkpoint"] != null) return decoder.json.decodeFromJsonElement(serializer<io.github.hosseinkarami_dev.near.rpc.models.RpcQueryRequest.CallFunctionBySyncCheckpoint>(), jobj)
                            ...
                            "view_global_contract_code" -> {
                                if (jobj["block_id"] != null) return decoder.json.decodeFromJsonElement(serializer<io.github.hosseinkarami_dev.near.rpc.models.RpcQueryRequest.ViewGlobalContractCodeByBlockId>(), jobj)
                                if (jobj["block_id"] != null) return decoder.json.decodeFromJsonElement(serializer<io.github.hosseinkarami_dev.near.rpc.models.RpcQueryRequest.ViewGlobalContractCodeByAccountIdByBlockId>(), jobj)
                                if (jobj["finality"] != null) return decoder.json.decodeFromJsonElement(serializer<io.github.hosseinkarami_dev.near.rpc.models.RpcQueryRequest.ViewGlobalContractCodeByFinality>(), jobj)
                                if (jobj["finality"] != null) return decoder.json.decodeFromJsonElement(serializer<io.github.hosseinkarami_dev.near.rpc.models.RpcQueryRequest.ViewGlobalContractCodeByAccountIdByFinality>(), jobj)
                                if (jobj["sync_checkpoint"] != null) return decoder.json.decodeFromJsonElement(serializer<io.github.hosseinkarami_dev.near.rpc.models.RpcQueryRequest.ViewGlobalContractCodeBySyncCheckpoint>(), jobj)
                                if (jobj["sync_checkpoint"] != null) return decoder.json.decodeFromJsonElement(serializer<io.github.hosseinkarami_dev.near.rpc.models.RpcQueryRequest.ViewGlobalContractCodeByAccountIdBySyncCheckpoint>(), jobj)
