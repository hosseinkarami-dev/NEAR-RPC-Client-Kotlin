...
object JsonRpcResponseForGenesisConfigAndRpcErrorSerializer : KSerializer<JsonRpcResponseForGenesisConfigAndRpcError> {
    ...
    override val descriptor: SerialDescriptor = buildClassSerialDescriptor("io.github.hosseinkarami_dev.near.rpc.models.JsonRpcResponseForGenesisConfigAndRpcError") {
    ...
    override fun serialize(encoder: Encoder, value: JsonRpcResponseForGenesisConfigAndRpcError) {
        if (encoder is JsonEncoder) {
            ...
            when (value) {
                is io.github.hosseinkarami_dev.near.rpc.models.JsonRpcResponseForGenesisConfigAndRpcError.Result -> {
                    val map = mutableMapOf<String, JsonElement>()
                    map["result"] = jsonEncoder.json.encodeToJsonElement(serializer<io.github.hosseinkarami_dev.near.rpc.models.GenesisConfig>(), value.result)
                ...
                is io.github.hosseinkarami_dev.near.rpc.models.JsonRpcResponseForGenesisConfigAndRpcError.Error -> {
                    val map = mutableMapOf<String, JsonElement>()
        ...
        when (value) {
            is io.github.hosseinkarami_dev.near.rpc.models.JsonRpcResponseForGenesisConfigAndRpcError.Result -> out.encodeSerializableElement(descriptor, 0, serializer<io.github.hosseinkarami_dev.near.rpc.models.JsonRpcResponseForGenesisConfigAndRpcError.Result>(), value)
            is io.github.hosseinkarami_dev.near.rpc.models.JsonRpcResponseForGenesisConfigAndRpcError.Error -> out.encodeSerializableElement(descriptor, 1, serializer<io.github.hosseinkarami_dev.near.rpc.models.JsonRpcResponseForGenesisConfigAndRpcError.Error>(), value)
        }
    ...
    override fun deserialize(decoder: Decoder): JsonRpcResponseForGenesisConfigAndRpcError {
        if (decoder is JsonDecoder) {
            ...
            when (element) {
                ...
                is JsonArray -> throw SerializationException("Unexpected JSON array while deserializing JsonRpcResponseForGenesisConfigAndRpcError")
                is JsonObject -> {
                    val jobj = element
                    if (jobj["result"] != null) {
                        val resultVal = decoder.json.decodeFromJsonElement(serializer<io.github.hosseinkarami_dev.near.rpc.models.GenesisConfig>(), jobj["result"] ?: throw SerializationException("Missing field 'result' for variant Result"))
                        ...
                        return io.github.hosseinkarami_dev.near.rpc.models.JsonRpcResponseForGenesisConfigAndRpcError.Result(resultVal, idVal, jsonrpcVal)
                    }
                    if (jobj["error"] != null) {
                        ...
                        return io.github.hosseinkarami_dev.near.rpc.models.JsonRpcResponseForGenesisConfigAndRpcError.Error(errorVal, idVal, jsonrpcVal)
                    }
                    if (jobj.size == 1) {
                        ...
                        when (key) {
                            "result" -> {
                                ...
                                return decoder.json.decodeFromJsonElement(serializer<io.github.hosseinkarami_dev.near.rpc.models.JsonRpcResponseForGenesisConfigAndRpcError.Result>(), obj)
                            }
                            "error" -> {
                                val obj = valueElem as? JsonObject ?: throw SerializationException("Expected object payload for variant error: " + key)
                                return decoder.json.decodeFromJsonElement(serializer<io.github.hosseinkarami_dev.near.rpc.models.JsonRpcResponseForGenesisConfigAndRpcError.Error>(), obj)
                            }
                    ...
                    if (typeField == null) throw SerializationException("Missing discriminator (one of changes_type) or recognizable variant in JsonRpcResponseForGenesisConfigAndRpcError")
                    val tf = typeField.trim()

                    // try exact match of full variant name first
                    val tfFull = tf
                    when (tfFull) {
                        "result" -> return decoder.json.decodeFromJsonElement(serializer<io.github.hosseinkarami_dev.near.rpc.models.JsonRpcResponseForGenesisConfigAndRpcError.Result>(), jobj)
                        "error" -> return decoder.json.decodeFromJsonElement(serializer<io.github.hosseinkarami_dev.near.rpc.models.JsonRpcResponseForGenesisConfigAndRpcError.Error>(), jobj)
                    ...
                    if (chosenGroupKey != null) {
                        when (chosenGroupKey) {
                            "result" -> {
                                try { return decoder.json.decodeFromJsonElement(serializer<io.github.hosseinkarami_dev.near.rpc.models.JsonRpcResponseForGenesisConfigAndRpcError.Result>(), jobj) } catch (_: Exception) { }
                                throw SerializationException("Cannot disambiguate variant for base token 'result' and tf='$tf'")
                            }
                            "error" -> {
                                try { return decoder.json.decodeFromJsonElement(serializer<io.github.hosseinkarami_dev.near.rpc.models.JsonRpcResponseForGenesisConfigAndRpcError.Error>(), jobj) } catch (_: Exception) { }
                    ...
                    if (requiredMatches.size == 1) {
                        when (requiredMatches[0]) {
                            0 -> return decoder.json.decodeFromJsonElement(serializer<io.github.hosseinkarami_dev.near.rpc.models.JsonRpcResponseForGenesisConfigAndRpcError.Result>(), jobj)
                            1 -> return decoder.json.decodeFromJsonElement(serializer<io.github.hosseinkarami_dev.near.rpc.models.JsonRpcResponseForGenesisConfigAndRpcError.Error>(), jobj)
                    ...
                    try { return decoder.json.decodeFromJsonElement(serializer<io.github.hosseinkarami_dev.near.rpc.models.JsonRpcResponseForGenesisConfigAndRpcError.Result>(), jobj) } catch (_: Exception) { }
                    try { return decoder.json.decodeFromJsonElement(serializer<io.github.hosseinkarami_dev.near.rpc.models.JsonRpcResponseForGenesisConfigAndRpcError.Error>(), jobj) } catch (_: Exception) { }
                    throw SerializationException("Missing discriminator or recognizable variant in JsonRpcResponseForGenesisConfigAndRpcError")
                }
            }
        }
