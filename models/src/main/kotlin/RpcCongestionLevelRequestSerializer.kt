...
object RpcCongestionLevelRequestSerializer : KSerializer<RpcCongestionLevelRequest> {
    ...
    override val descriptor: SerialDescriptor = buildClassSerialDescriptor("io.github.hosseinkarami_dev.near.rpc.models.RpcCongestionLevelRequest") {
    ...
    override fun serialize(encoder: Encoder, value: RpcCongestionLevelRequest) {
        if (encoder is JsonEncoder) {
            ...
            when (value) {
                is io.github.hosseinkarami_dev.near.rpc.models.RpcCongestionLevelRequest.BlockShardId -> {
                ...
                is io.github.hosseinkarami_dev.near.rpc.models.RpcCongestionLevelRequest.ChunkHash -> {
                    val map = mutableMapOf<String, JsonElement>()
        ...
        when (value) {
            is io.github.hosseinkarami_dev.near.rpc.models.RpcCongestionLevelRequest.BlockShardId -> out.encodeSerializableElement(descriptor, 0, serializer<io.github.hosseinkarami_dev.near.rpc.models.RpcCongestionLevelRequest.BlockShardId>(), value)
            is io.github.hosseinkarami_dev.near.rpc.models.RpcCongestionLevelRequest.ChunkHash -> out.encodeSerializableElement(descriptor, 1, serializer<io.github.hosseinkarami_dev.near.rpc.models.RpcCongestionLevelRequest.ChunkHash>(), value)
        }
        ...
        if (decoder is JsonDecoder) {
            ...
            when (element) {
                is JsonPrimitive -> {
                    ...
                    throw SerializationException("Unknown discriminator (primitive) for RpcCongestionLevelRequest")
                }
                is JsonArray -> throw SerializationException("Unexpected JSON array while deserializing RpcCongestionLevelRequest")
                is JsonObject -> {
                    val jobj = element
                    if (jobj["block_id"] != null) {
                        ...
                        return io.github.hosseinkarami_dev.near.rpc.models.RpcCongestionLevelRequest.BlockShardId(blockIdVal, shardIdVal)
                    }
                    if (jobj["chunk_id"] != null) {
                        return io.github.hosseinkarami_dev.near.rpc.models.RpcCongestionLevelRequest.ChunkHash(decoder.json.decodeFromJsonElement(serializer<io.github.hosseinkarami_dev.near.rpc.models.CryptoHash>(), jobj["chunk_id"]!!))
                    }
                    if (jobj.size == 1) {
                        ...
                        when (key) {
                            "block_shard_id" -> {
                                ...
                                return decoder.json.decodeFromJsonElement(serializer<io.github.hosseinkarami_dev.near.rpc.models.RpcCongestionLevelRequest.BlockShardId>(), obj)
                            }
                            "chunk_hash" -> {
                                val obj = valueElem as? JsonObject ?: throw SerializationException("Expected object payload for variant chunk_hash: " + key)
                                return decoder.json.decodeFromJsonElement(serializer<io.github.hosseinkarami_dev.near.rpc.models.RpcCongestionLevelRequest.ChunkHash>(), obj)
                            }
                    ...
                    if (typeField == null) throw SerializationException("Missing discriminator (one of changes_type) or recognizable variant in RpcCongestionLevelRequest")
                    val tf = typeField.trim()

                    // try exact match of full variant name first
                    val tfFull = tf
                    when (tfFull) {
                        "block_shard_id" -> return decoder.json.decodeFromJsonElement(serializer<io.github.hosseinkarami_dev.near.rpc.models.RpcCongestionLevelRequest.BlockShardId>(), jobj)
                        "chunk_hash" -> return decoder.json.decodeFromJsonElement(serializer<io.github.hosseinkarami_dev.near.rpc.models.RpcCongestionLevelRequest.ChunkHash>(), jobj)
                    ...
                    if (chosenGroupKey != null) {
                        when (chosenGroupKey) {
                            "block_shard_id" -> {
                                try { return decoder.json.decodeFromJsonElement(serializer<io.github.hosseinkarami_dev.near.rpc.models.RpcCongestionLevelRequest.BlockShardId>(), jobj) } catch (_: Exception) { }
                                throw SerializationException("Cannot disambiguate variant for base token 'block_shard_id' and tf='$tf'")
                            }
                            "chunk_hash" -> {
                                try { return decoder.json.decodeFromJsonElement(serializer<io.github.hosseinkarami_dev.near.rpc.models.RpcCongestionLevelRequest.ChunkHash>(), jobj) } catch (_: Exception) { }
                    ...
                    if (requiredMatches.size == 1) {
                        when (requiredMatches[0]) {
                            0 -> return decoder.json.decodeFromJsonElement(serializer<io.github.hosseinkarami_dev.near.rpc.models.RpcCongestionLevelRequest.BlockShardId>(), jobj)
                            1 -> return decoder.json.decodeFromJsonElement(serializer<io.github.hosseinkarami_dev.near.rpc.models.RpcCongestionLevelRequest.ChunkHash>(), jobj)
                    ...
                    try { return decoder.json.decodeFromJsonElement(serializer<io.github.hosseinkarami_dev.near.rpc.models.RpcCongestionLevelRequest.BlockShardId>(), jobj) } catch (_: Exception) { }
                    try { return decoder.json.decodeFromJsonElement(serializer<io.github.hosseinkarami_dev.near.rpc.models.RpcCongestionLevelRequest.ChunkHash>(), jobj) } catch (_: Exception) { }
                    throw SerializationException("Missing discriminator or recognizable variant in RpcCongestionLevelRequest")
                }
            }
        }
