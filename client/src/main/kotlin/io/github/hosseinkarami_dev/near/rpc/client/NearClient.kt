...
public class NearClient(
  ...
  public suspend fun experimentalChanges(params: RpcStateChangesInBlockByTypeRequest): RpcResponse<RpcStateChangesInBlockResponse> {
    ...
    val httpResponse = try {
      ...
      return RpcResponse.Failure(RpcError(-1000, "Network error: ${e.message}"))
    }
    val respBody = try {
      httpResponse.bodyAsText()
    } catch (e: Exception) {
      return RpcResponse.Failure(RpcError(-1001, "Could not read body: ${e.message}"))
    }
    val envelope = try {
      json.decodeFromString(JsonRpcEnvelope.serializer(RpcStateChangesInBlockResponse.serializer()), respBody)
    } catch (e: Exception) {
      return RpcResponse.Failure(RpcError(-1002, "Invalid JSON-RPC envelope: ${e.message}"))
    }
    envelope.error?.let { return RpcResponse.Failure(it) }
    val result = envelope.result ?: return RpcResponse.Failure(RpcError(-1003, "Missing result field"))
  ...
  public suspend fun experimentalChangesInBlock(params: RpcStateChangesInBlockRequest): RpcResponse<RpcStateChangesInBlockByTypeResponse> {
    ...
    val envelope = try {
      json.decodeFromString(JsonRpcEnvelope.serializer(RpcStateChangesInBlockByTypeResponse.serializer()), respBody)
    } catch (e: Exception) {
      return RpcResponse.Failure(RpcError(-1002, "Invalid JSON-RPC envelope: ${e.message}"))
    }
    envelope.error?.let { return RpcResponse.Failure(it) }
  ...
  public suspend fun experimentalCongestionLevel(params: RpcCongestionLevelRequest): RpcResponse<RpcCongestionLevelResponse> {
    ...
    val envelope = try {
      json.decodeFromString(JsonRpcEnvelope.serializer(RpcCongestionLevelResponse.serializer()), respBody)
    } catch (e: Exception) {
      return RpcResponse.Failure(RpcError(-1002, "Invalid JSON-RPC envelope: ${e.message}"))
    }
    envelope.error?.let { return RpcResponse.Failure(it) }
  ...
  public suspend fun experimentalGenesisConfig(): RpcResponse<GenesisConfig> {
    ...
    val envelope = try {
      json.decodeFromString(JsonRpcEnvelope.serializer(GenesisConfig.serializer()), respBody)
    } catch (e: Exception) {
      return RpcResponse.Failure(RpcError(-1002, "Invalid JSON-RPC envelope: ${e.message}"))
    }
    envelope.error?.let { return RpcResponse.Failure(it) }
  ...
  public suspend fun experimentalLightClientBlockProof(params: RpcLightClientBlockProofRequest): RpcResponse<RpcLightClientBlockProofResponse> {
    ...
    val envelope = try {
      json.decodeFromString(JsonRpcEnvelope.serializer(RpcLightClientBlockProofResponse.serializer()), respBody)
    } catch (e: Exception) {
      return RpcResponse.Failure(RpcError(-1002, "Invalid JSON-RPC envelope: ${e.message}"))
    }
    envelope.error?.let { return RpcResponse.Failure(it) }
  ...
  public suspend fun experimentalLightClientProof(params: RpcLightClientExecutionProofRequest): RpcResponse<RpcLightClientExecutionProofResponse> {
    ...
    val envelope = try {
      json.decodeFromString(JsonRpcEnvelope.serializer(RpcLightClientExecutionProofResponse.serializer()), respBody)
    } catch (e: Exception) {
      return RpcResponse.Failure(RpcError(-1002, "Invalid JSON-RPC envelope: ${e.message}"))
    }
    envelope.error?.let { return RpcResponse.Failure(it) }
  ...
  public suspend fun experimentalMaintenanceWindows(params: RpcMaintenanceWindowsRequest): RpcResponse<List<RangeOfUint64>> {
    ...
    val envelope = try {
      json.decodeFromString(JsonRpcEnvelope.serializer(ListSerializer(RangeOfUint64.serializer())), respBody)
    } catch (e: Exception) {
      return RpcResponse.Failure(RpcError(-1002, "Invalid JSON-RPC envelope: ${e.message}"))
    }
    envelope.error?.let { return RpcResponse.Failure(it) }
  ...
  public suspend fun experimentalProtocolConfig(params: RpcProtocolConfigRequest): RpcResponse<RpcProtocolConfigResponse> {
    ...
    val envelope = try {
      json.decodeFromString(JsonRpcEnvelope.serializer(RpcProtocolConfigResponse.serializer()), respBody)
    } catch (e: Exception) {
      return RpcResponse.Failure(RpcError(-1002, "Invalid JSON-RPC envelope: ${e.message}"))
    }
    envelope.error?.let { return RpcResponse.Failure(it) }
  ...
  public suspend fun experimentalReceipt(params: RpcReceiptRequest): RpcResponse<RpcReceiptResponse> {
    ...
    val envelope = try {
      json.decodeFromString(JsonRpcEnvelope.serializer(RpcReceiptResponse.serializer()), respBody)
    } catch (e: Exception) {
      return RpcResponse.Failure(RpcError(-1002, "Invalid JSON-RPC envelope: ${e.message}"))
    }
    envelope.error?.let { return RpcResponse.Failure(it) }
   ...
   *
   * @param params Request parameters: `io.github.hosseinkarami_dev.near.rpc.models.RpcSplitStorageInfoRequest` (required).
   * @return Response: `RpcResponse<RpcSplitStorageInfoResponse>`.
   */
  public suspend fun experimentalSplitStorageInfo(params: RpcSplitStorageInfoRequest): RpcResponse<RpcSplitStorageInfoResponse> {
    ...
    val envelope = try {
      json.decodeFromString(JsonRpcEnvelope.serializer(RpcSplitStorageInfoResponse.serializer()), respBody)
    } catch (e: Exception) {
      return RpcResponse.Failure(RpcError(-1002, "Invalid JSON-RPC envelope: ${e.message}"))
    }
    envelope.error?.let { return RpcResponse.Failure(it) }
  ...
  public suspend fun experimentalTxStatus(params: RpcTransactionStatusRequest): RpcResponse<RpcTransactionResponse> {
    ...
    val envelope = try {
      json.decodeFromString(JsonRpcEnvelope.serializer(RpcTransactionResponse.serializer()), respBody)
    } catch (e: Exception) {
      return RpcResponse.Failure(RpcError(-1002, "Invalid JSON-RPC envelope: ${e.message}"))
    }
    envelope.error?.let { return RpcResponse.Failure(it) }
  ...
  public suspend fun experimentalValidatorsOrdered(params: RpcValidatorsOrderedRequest): RpcResponse<List<ValidatorStakeView>> {
    ...
    val envelope = try {
      json.decodeFromString(JsonRpcEnvelope.serializer(ListSerializer(ValidatorStakeView.serializer())), respBody)
    } catch (e: Exception) {
      return RpcResponse.Failure(RpcError(-1002, "Invalid JSON-RPC envelope: ${e.message}"))
    }
    envelope.error?.let { return RpcResponse.Failure(it) }
  ...
  public suspend fun block(params: RpcBlockRequest): RpcResponse<RpcBlockResponse> {
    ...
    val envelope = try {
      json.decodeFromString(JsonRpcEnvelope.serializer(RpcBlockResponse.serializer()), respBody)
    } catch (e: Exception) {
      return RpcResponse.Failure(RpcError(-1002, "Invalid JSON-RPC envelope: ${e.message}"))
    }
    envelope.error?.let { return RpcResponse.Failure(it) }
  ...
  public suspend fun broadcastTxAsync(params: RpcSendTransactionRequest): RpcResponse<CryptoHash> {
    ...
    val envelope = try {
      json.decodeFromString(JsonRpcEnvelope.serializer(CryptoHash.serializer()), respBody)
    } catch (e: Exception) {
      return RpcResponse.Failure(RpcError(-1002, "Invalid JSON-RPC envelope: ${e.message}"))
    }
    envelope.error?.let { return RpcResponse.Failure(it) }
  ...
  public suspend fun chunk(params: RpcChunkRequest): RpcResponse<RpcChunkResponse> {
    ...
    val envelope = try {
      json.decodeFromString(JsonRpcEnvelope.serializer(RpcChunkResponse.serializer()), respBody)
    } catch (e: Exception) {
      return RpcResponse.Failure(RpcError(-1002, "Invalid JSON-RPC envelope: ${e.message}"))
    }
    envelope.error?.let { return RpcResponse.Failure(it) }
  ...
  public suspend fun clientConfig(): RpcResponse<RpcClientConfigResponse> {
    ...
    val envelope = try {
      json.decodeFromString(JsonRpcEnvelope.serializer(RpcClientConfigResponse.serializer()), respBody)
    } catch (e: Exception) {
      return RpcResponse.Failure(RpcError(-1002, "Invalid JSON-RPC envelope: ${e.message}"))
    }
    envelope.error?.let { return RpcResponse.Failure(it) }
  ...
  public suspend fun gasPrice(params: RpcGasPriceRequest): RpcResponse<RpcGasPriceResponse> {
    ...
    val envelope = try {
      json.decodeFromString(JsonRpcEnvelope.serializer(RpcGasPriceResponse.serializer()), respBody)
    } catch (e: Exception) {
      return RpcResponse.Failure(RpcError(-1002, "Invalid JSON-RPC envelope: ${e.message}"))
    }
    envelope.error?.let { return RpcResponse.Failure(it) }
  ...
  public suspend fun health(): RpcResponse<RpcHealthResponse?> {
    ...
    val envelope = try {
      json.decodeFromString(JsonRpcEnvelope.serializer(RpcHealthResponse.serializer()), respBody)
    } catch (e: Exception) {
      return RpcResponse.Failure(RpcError(-1002, "Invalid JSON-RPC envelope: ${e.message}"))
    }
    envelope.error?.let { return RpcResponse.Failure(it) }
  ...
  public suspend fun networkInfo(): RpcResponse<RpcNetworkInfoResponse> {
    ...
    val envelope = try {
      json.decodeFromString(JsonRpcEnvelope.serializer(RpcNetworkInfoResponse.serializer()), respBody)
    } catch (e: Exception) {
      return RpcResponse.Failure(RpcError(-1002, "Invalid JSON-RPC envelope: ${e.message}"))
    }
    envelope.error?.let { return RpcResponse.Failure(it) }
  ...
  public suspend fun nextLightClientBlock(params: RpcLightClientNextBlockRequest): RpcResponse<RpcLightClientNextBlockResponse> {
    ...
    val envelope = try {
      json.decodeFromString(JsonRpcEnvelope.serializer(RpcLightClientNextBlockResponse.serializer()), respBody)
    } catch (e: Exception) {
      return RpcResponse.Failure(RpcError(-1002, "Invalid JSON-RPC envelope: ${e.message}"))
    }
    envelope.error?.let { return RpcResponse.Failure(it) }
  ...
  public suspend fun query(params: RpcQueryRequest): RpcResponse<RpcQueryResponse> {
    ...
    val envelope = try {
      json.decodeFromString(JsonRpcEnvelope.serializer(RpcQueryResponse.serializer()), respBody)
    } catch (e: Exception) {
      return RpcResponse.Failure(RpcError(-1002, "Invalid JSON-RPC envelope: ${e.message}"))
    }
    envelope.error?.let { return RpcResponse.Failure(it) }
  ...
  public suspend fun status(): RpcResponse<RpcStatusResponse> {
    ...
    val envelope = try {
      json.decodeFromString(JsonRpcEnvelope.serializer(RpcStatusResponse.serializer()), respBody)
    } catch (e: Exception) {
      return RpcResponse.Failure(RpcError(-1002, "Invalid JSON-RPC envelope: ${e.message}"))
    }
    envelope.error?.let { return RpcResponse.Failure(it) }
  ...
  public suspend fun validators(params: RpcValidatorRequest): RpcResponse<RpcValidatorResponse> {
    ...
    val envelope = try {
      json.decodeFromString(JsonRpcEnvelope.serializer(RpcValidatorResponse.serializer()), respBody)
    } catch (e: Exception) {
      return RpcResponse.Failure(RpcError(-1002, "Invalid JSON-RPC envelope: ${e.message}"))
    }
    envelope.error?.let { return RpcResponse.Failure(it) }
